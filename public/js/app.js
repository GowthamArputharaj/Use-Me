 ...
 */
// require('./bootstrap');
__webpack_require__(/*! ./g_custom.js */ "./resources/js/g_custom.js");


window.$ = window.jQuery = (jquery__WEBPACK_IMPORTED_MODULE_0___default()); // window.Vue = require('vue').default;
